        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="signup-user.php" method="POST" autocomplete="">
                    <h2 class="text-center">Εγγραφή για την πλατφόρμα μελών ΕΛΠΕ</h2>
                    <p class="text-center">Αν πατήσετε Signup αποδέχεστε την χρήση cookies λειτουργικότητας αυτής της πλατφόρμας</p>
                    <?php
                    if(count($errors) == 1){
                        ?>
