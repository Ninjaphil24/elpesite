<?php
   ...
   <?php
    ...
    <form method="post" action="bedit.php?eid=<?php echo urlencode($eid) ?>&reviewtype=<?php echo urlencode($reviewtype) ?>&title=<?php echo urlencode($title) ?>&cid=<?php echo urlencode($cid) ?>&comment=<?php echo urlencode($comment) ?>">
