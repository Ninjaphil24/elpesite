...
$del = mysqli_query($con,"DELETE FROM bcomments WHERE cid = '$cid'"); // delete query

if($del)
{
    mysqli_close($con); // Close connection
    header("location:barticle.php?eid=$eid&reviewtype=$reviewtype&title=$title"); // redirects to all records page
    exit;	
}
else
{
